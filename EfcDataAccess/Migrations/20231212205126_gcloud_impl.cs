...
{
    /// <inheritdoc />
    public partial class gcloud_impl : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomProfiles_ThresholdsLimits_ThresholdId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentRoomProfileId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Homes", x => x.HomeId);
                    table.ForeignKey(
                        name: "FK_Homes_RoomProfiles_CurrentRoomProfileId",
                        column: x => x.CurrentRoomProfileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homes_CurrentRoomProfileId",
                table: "Homes",
                column: "CurrentRoomProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomProfiles_ThresholdId",
                table: "RoomProfiles",
                column: "ThresholdId");
